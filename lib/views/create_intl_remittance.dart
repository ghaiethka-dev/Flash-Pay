          ...
          return SingleChildScrollView(
            ...
            child: Column(
              ...
              children: [
                ...
                Row(
                  children: [
                    Expanded(flex: 2, child: _buildTextField(context: context, label: "المبلغ *", hint: "مثال: 500", icon: Icons.attach_money, controller: controller.amountController, keyboardType: TextInputType.number, color: const Color(0xFF2980B9))),
                ...
                _buildDropdownField(context: context, label: "وكيل التسليم المحلي (مَن ستسلمه المبلغ) *", hint: "اختر الوكيل في منطقتك", value: controller.selectedAgent.value, items: controller.agents, onChanged: (val) => controller.selectedAgent.value = val, color: const Color(0xFF2980B9)),
                const SizedBox(height: 32),
